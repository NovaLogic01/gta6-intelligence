          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            {!result.match ? (
              <div className="p-8 border border-border-primary bg-bg-secondary/20 relative">
                ...
                <h3 className="text-2xl text-text-primary font-medium mb-3">Unverified Claim</h3>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                      {result.related.slice(0, 3).map((rel, i) => (
                        <Link key={i} href={`/database/${rel.category}s/${rel.slug}`} className="p-4 border border-border-primary/30 bg-bg-secondary/10 hover:border-accent-blue/30 hover:bg-bg-hover transition-colors group">
